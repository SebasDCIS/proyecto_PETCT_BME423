...
Verificada en `runs/*/resumen.json` de A, A_s2, A_s3, B, B_s2 (y en la línea de lanzamiento
de B_s3): todos los campos coinciden salvo `modelo` y `semilla`.
...
| B_s3 | en curso (misma configuración, comprobada en el log) | | |
| C, C_s2, C_s3 | en cola | | |
